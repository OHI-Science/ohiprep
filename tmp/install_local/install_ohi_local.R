...
#   1. rCharts-master.zip:    contains mapping support (from https://github.com/OHI-Science/rcharts)
#   2. ohicore-master.zip:    contains all OHI Toolbox functionality (from https://github.com/OHI-Science/ohicore)
#   3. ohi-global-master.zip: contains all data from OHI global assessments (from https://github.com/OHI-Science/ohi-global)
...
for (p in c('devtools','httr', 'caTools', 'httpuv', 'RColorBrewer', 'shiny')){
