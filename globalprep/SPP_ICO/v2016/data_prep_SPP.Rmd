...
am_cells_spp_sum <- process_am_summary_per_cell(spp_all3, fn_tag = '_40_nobirds', prob_filter = 0.4, reload = FALSE)
am_cells_spp_sum <- process_am_summary_per_cell(fn_tag = '_0', prob_filter = 0, reload = FALSE)
...
iucn_cells_spp_sum <- process_iucn_summary_per_cell(spp_all3, fn_tag = '_nobirds', reload = FALSE)
### loiczid | mean_cat_score | mean_trend_score | n_cat_species | n_trend_species
...
summary_by_loiczid <- process_means_per_cell(am_cells_spp_sum, iucn_cells_spp_sum, fn_tag = '_40_nobirds')
...
summary_by_rgn <- process_means_per_rgn(summary_by_loiczid, rgn_cell_lookup, rgn_note = 'gl_40_nobirds')
### This returns dataframe with variables:
...
write_csv(spp_status, file.path(dir_git, scenario, 'output/spp_status_global_40_nobirds.csv'))
write_csv(spp_trend,  file.path(dir_git, scenario, 'output/spp_trend_global_40_nobirds.csv'))
```
...
st_2016v2015 <- ggplot(status_df, aes(x = st_2015, y = st_2016)) + 
  ...
  labs(title = 'Status: 2016 vs 2015 40 nobirds')
