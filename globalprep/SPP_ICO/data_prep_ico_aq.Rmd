...
``` {r write outputs}
write.csv(ico_aq_all %>% select(rgn_id, sciname, category), 
          file.path(dir_git, 'globalprep/SPP_ICO/v2015/data/ico_status_aq.csv'))
write.csv(ico_aq_all %>% select(rgn_id, sciname, popn_trend), 
          file.path(dir_git, 'globalprep/SPP_ICO/v2015/data/ico_trend_aq.csv'))
```
