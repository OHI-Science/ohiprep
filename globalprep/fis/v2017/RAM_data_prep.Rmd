...
Reference: RAM Legacy Stock Assessment Database v3.8. 2017. http://ramlegacy.org.
...
A few of the predicted B/Bmsy values go below zero.  We convert anything with a RAM BBmsy value < 0.015 to 0.015, which is the minimum observed B/Bmsy value in the data.
