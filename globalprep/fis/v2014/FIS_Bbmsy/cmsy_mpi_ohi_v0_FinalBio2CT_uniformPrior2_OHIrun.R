...
runCMSY<-function(){
  ...
  finalbio    <- c(0.01,0.7) ## use for batch processing   ****THIS IS AN UPDATE FROM RAINER--Oct 12, 2012
...
cmsy.ohi.df<-do.call(rbind,tmp0)

rownames(cmsy.ohi.df)<-NULL

file.string<-paste("./cmsy_ohi_results_table.RData", sep="")
save(list = c("cmsy.ohi.df"), file = file.string)
