...
write.csv(stks, file = 'globalprep/fis/v2016/int/catch_pre_bbmsy.csv')
...
stks[stks$stock_id == 'Acetes_japonicus-61', ]
tail(stks[stks$stock_id == "Theragra_chalcogramma-61", ])
tail(old[old$stock_id == "Theragra_chalcogramma-61", ])
