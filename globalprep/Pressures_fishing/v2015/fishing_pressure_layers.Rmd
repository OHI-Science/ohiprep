---
title: 'OHI: Pressures - Commercial Fishing '
...
*NOTE: Data prep information for the VGPM productivity data can be found [here](https://github.com/OHI-Science/ohiprep/tree/master/globalprep/VGPM_primary_productivity/v2015)
...
catch_06_10 = raster(file.path(dir_N,'git-annex/globalprep/Pressures_fishing/v2015/catch_km_06_10.tif'))
catch_05_09 = raster(file.path(dir_N,'git-annex/globalprep/Pressures_fishing/v2015/catch_km_05_09.tif'))
catch_04_08 = raster(file.path(dir_N,'git-annex/globalprep/Pressures_fishing/v2015/catch_km_04_08.tif'))
catch_03_07 = raster(file.path(dir_N,'git-annex/globalprep/Pressures_fishing/v2015/catch_km_03_07.tif'))
...
npp_06_10 = raster(file.path(dir_N,'git-annex/globalprep/Pressures_fishing/v2015/npp/npp_06_10.tif'))
...
npp_05_09 = raster(file.path(dir_N,'git-annex/globalprep/Pressures_fishing/v2015/npp/npp_05_09.tif'))
...
npp_04_08 = raster(file.path(dir_N,'git-annex/globalprep/Pressures_fishing/v2015/npp/npp_04_08.tif'))
...
npp_03_07 = raster(file.path(dir_N,'git-annex/globalprep/Pressures_fishing/v2015/npp/npp_03_07.tif'))
...
These rasters were created in this [dataprep.R](https://github.com/OHI-Science/ohiprep/blob/master/globalprep/Pressures_fishing/v2015/dataprep.R) script

```{r}
gear_hb = raster(file.path(dir_N,'git-annex/globalprep/Pressures_fishing/v2015/gear_prop_hb_moll_1km_ocean.tif'))
gear_lb = raster(file.path(dir_N,'git-annex/globalprep/Pressures_fishing/v2015/gear_prop_lb_moll_1km_ocean.tif'))
```
...
```{r, eval=F}
catch_npp_06_10 = overlay(catch_06_10,npp_06_10,fun=function(x,y){x/y},progress='text',filename=file.path(dir_N,'git-annex/globalprep/Pressures_fishing/v2015/catch_npp_06_10.tif'))
catch_npp_05_09 = overlay(catch_05_09,npp_05_09,fun=function(x,y){x/y},progress='text',filename=file.path(dir_N,'git-annex/globalprep/Pressures_fishing/v2015/catch_npp_05_09.tif'))
catch_npp_04_08 = overlay(catch_04_08,npp_04_08,fun=function(x,y){x/y},progress='text',file.path(dir_N,'git-annex/globalprep/Pressures_fishing/v2015/catch_npp_04_08.tif'))
catch_npp_03_07 = overlay(catch_03_07,npp_03_07,fun=function(x,y){x/y},progress='text',filename=file.path(dir_N,'git-annex/globalprep/Pressures_fishing/v2015/catch_npp_03_07.tif'))
```
