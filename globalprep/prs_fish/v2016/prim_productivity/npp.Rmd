...
This script calculates mean annual net primary production values globally from 2003 to 2015. This data is used to standardize commercial fishing catch to produce [fishing pressure layers for OHI](https://cdn.rawgit.com/OHI-Science/ohiprep/master/globalprep/prs_fish/v2016/fishing_pressure_layers.html).


#Updates from previous assessment

Two additional years of data are incorporated; 2014 and 2015.
