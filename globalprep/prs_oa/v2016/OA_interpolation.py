...
feature_dir = r'M:\git-annex\globalprep\prs_oa\v2016\int\annual_oa_rescaled' #feature directory is where Arc considers the 'home' for this script
# the r above means treat the following as a raw string (don't escape the backslashes)
output_raster_dir = r'M:\git-annex\globalprep\prs_oa\v2016\int\annual_oa_rescaled_int'
...
rasters = glob.glob('M:/git-annex/globalprep/prs_oa/v2016/int/annual_oa_rescaled/*.tif') 
