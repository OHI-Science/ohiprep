...
```{r rescale}
out_files <- list.files(file.path(dir_M,'git-annex/globalprep/prs_uv/v2016/output'),full.names=T, pattern = '9_m')
...
vals <- vals[!is.na(vals)]
   resc_num         <- quantile(vals,prob=0.9999) # calculate the 99.99th quantile  
