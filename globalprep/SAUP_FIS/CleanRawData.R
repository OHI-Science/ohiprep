...
#############Prepare catch data  ####################
#####################################################
eez <- read.csv(file.path(dir_neptune_data, "git-annex/globalprep/SAUP_data_2015/raw/Catch_Value_11062015.csv"), header = FALSE)
...
write.csv(eez_catch, file.path(dir_neptune_data, 'git-annex/globalprep/SAUP_data_2015/tmp/Catch_Value_11062015_summary.csv'), row.names=FALSE)
...
write.csv(b_bmsy, file.path(dir_neptune_data, 'git-annex/globalprep/SAUP_data_2015/tmp/b_bmsy_11062015.csv'), row.names=FALSE)
