...
##############################################################################=
filter(data_all, country=='Albania' & year==1991)  # ? what's the point of this one?
...
write_csv(wb_pop, file.path(dir_int, 'wb_country_total_pop.csv'))
