...
write.csv(health, sprintf("output/hab_ice_health_eez.csv"), row.names=FALSE)
...
write.csv(trend, sprintf("output/hab_ice_trend_eez.csv"), row.names=FALSE)
...
write.csv(extent, sprintf("output/hab_ice_extent_eez.csv"), row.names=FALSE)
