...
write.csv(hb, "globalprep/PressuresRegionExtract/data/catch_06_10_npp_hb_eez_gf.csv")
...
write.csv(slr, "globalprep/PressuresRegionExtract/data/slr_eez_2015_gf.csv")

#### acid: spatial interpolation of raster data
acid <- read.csv("globalprep/PressuresRegionExtract/data/acid_gap_fill_attr.csv")%>%
  select(rgn_id, pressure_score = gap_filled)
write.csv(acid, "globalprep/PressuresRegionExtract/data/acid_eez_2014_gf.csv")
