---
title: "Sea Level Rise Pressure Layer for OHI 2015"
...
**Attribution and Citation Information**

If this methodology or data is used in publication, please make attribution clear by using the citation found in the release for OHI 2015.
...
knitr::opts_knit$set(root.dir = file.path(dir_N,'git-annex/globalprep/Pressures_SeaLevelRise'))
...
Interpolating the data was done using ArcGIS. All NA cells were interpolated using nearest neighbor. The python script can be found [here](https://github.com/OHI-Science/ohiprep/blob/master/globalprep/Pressures_SeaLevelRise/scripts/SLR_interpolation.py)  
