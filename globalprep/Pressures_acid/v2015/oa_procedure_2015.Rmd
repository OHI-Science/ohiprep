...
```{r}
 ...
 # sapply(rescaled,resample)
  ...
  plot(raster('working/annual_oa_rescaled_1km_2014.tif'),col=cols,main='Rescaled to 1km (2014)')
...
plot(raster('working/annual_oa_rescaled_1km_int_2014.tif'),col=cols,main='Interpolation to fill in NAs')
```
***
...
```{r}
    ...
    interp_cells = mask(r_c,r_1km,progress='text',inverse=TRUE)
