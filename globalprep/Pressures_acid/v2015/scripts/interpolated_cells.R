...
dat = raster(file.path(dir_N,'git-annex/globalprep/Pressures_acid/v2015/working/annualmean_2005-2014/moll/global_arag_avg_moll_2005.tif'))

out = raster(file.path(dir_N,'git-annex/globalprep/Pressures_acid/v2015/working/annual_oa_1km/oa_1km_2005.tif'))
...
#writeRaster(int_cells,filename=file.path(dir_N,'git-annex/globalprep/Pressures_acid/v2015/working/interpolated_cells.tif'),progress='text',overwrite=T)
