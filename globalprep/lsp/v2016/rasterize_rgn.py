...
### paths
data_yr = 'd2014'
dir_anx = '%s/git-annex/globalprep/spatial/data' % (dirs['mazu'], data_yr)
print ('dir_anx = ' + dir_anx)


### inputs
poly_rgn_all  = '%s/regions_mol.shp' % dir_anx
rast_base = '%s/rgn_raster_500m/rgn_offshore3nm_mol_500mcell.tif' % dir_anx

print ('input poly_rgn_all = ' + poly_wdpa)
...
rast_out  = '%s/rgn_raster_500m/regions_mol.tif' % dir_anx
...
arcpy.PolygonToRaster_conversion(poly_eez_tmp, 'rgn_id', rast_out, 'MAXIMUM_COMBINED_AREA', rast_base)
