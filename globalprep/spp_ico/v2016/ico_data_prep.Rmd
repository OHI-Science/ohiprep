...
spp_list_from_api_file <- file.path(dir_goal, scenario, 'int/spp_list_from_api.csv')
...
write_csv(ico_list, file.path(dir_goal, scenario, 'int/ico_list_prepped.csv'))
...
ico_spp_rgn_raw <- read_csv(file.path(dir_goal, scenario, 'int/ico_spp_countries_raw.csv'))

rgn_iucn2ohi <- read_csv(file.path(dir_goal, scenario, 'raw/rgns_iucn2ohi.csv'))
...
`r knitr::kable(head(ico_spp_rgn))`
...
ico_cat_ts_abbr <- read_csv(file.path(dir_goal, scenario, 'int/ico_spp_cat.csv')) %>%
...
write_csv(ico_status_raw1, file.path(dir_goal, scenario, 'output/ico_spp_iucn_status.csv'))
...
ggsave(file.path(dir_goal, scenario, 'Figs/scatterplot_status_15v16.png'))
...
ggsave(file.path(dir_goal, scenario, 'Figs/scatterplot_trend_15v16.png'))
