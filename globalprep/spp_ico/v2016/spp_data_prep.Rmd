...
write_csv(rgn_spp_gl,  file.path(dir_goal, 'output/rgn_spp_gl.csv'))
write_csv(rgn_spp_3nm, file.path(dir_goal, 'output/rgn_spp_3nm.csv'))
write_csv(rgn_spp_aq,  file.path(dir_goal, 'output/rgn_spp_aq.csv'))
write_csv(rgn_spp_hs,  file.path(dir_goal, 'output/rgn_spp_hs.csv'))
```
