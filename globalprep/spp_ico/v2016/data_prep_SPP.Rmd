...
``` {r plot_scores_vs_2015, eval = TRUE}
...
st_2016_2015 <- ggplot(status_df, aes(x = st_2015, y = st_2016, key = rgn_name)) + 
  geom_point() +
  geom_abline(slope = 1, intercept = 0, color = 'red') +
  scale_x_continuous(limits = c(0, 1)) +
  scale_y_continuous(limits = c(0, 1)) +
  labs(x = 'Status: data d2014/scenario v2015',
       y = 'Status: data d2015/scenario v2016',
       title = 'Status: v2015(d2014) by v2016(d2015)')
library(plotly)
...
st_2016_d14v16 <- ggplot(status_df, aes(x = st_d14v16, y = st_2016, key = rgn_name)) + 
  geom_point() +
  geom_abline(slope = 1, intercept = 0, color = 'red') +
  scale_x_continuous(limits = c(0, 1)) +
  scale_y_continuous(limits = c(0, 1)) +
  labs(x = 'Status: data d2014/scenario v2016',
       y = 'Status: data d2015/scenario v2016',
       title = 'Status: 2016 methods (v2016); d2015 vs d2014 data')
# library(plotly)
ggplotly(st_2016_d14v16)
# print(st_2016_d14v16)
ggsave(file.path(dir_git, scenario, 'output/scatterplot_spp_status_global_d15v16_d14v16.png'),
       plot = st_2016_d14v16)
