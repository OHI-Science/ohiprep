...
`r knitr::kable(read_csv(file.path(dir_anx, scenario, 'int/spp_iucn_marine.csv'), n_max = 5), caption = 'IUCN marine species list and info from spp_iucn_marine.csv (first few rows)')`
...
`r knitr::kable(read_csv(file.path(dir_anx, scenario, 'int/spp_all_cleaned.csv'), n_max = 5), caption = 'Combined species list from spp_all_cleaned.csv (first few rows)')`
...
# source(file.path(dir_git, scenario, 'score_plot_spp.R'))
