...
dir_data_am    <- file.path(dir_M, 'git-annex/globalprep/_raw_data', 'aquamaps', str_replace(scenario, 'v', 'd')) 
...
if(reload) {
  ...
  ### | am_sid | sciname | am_category | iucn_sid | iucn_category | pop_trend | pop_category | 
...
`r DT::datatable(summary_by_rgn, caption = 'Region summary: mean category, trend, and status')`
...
st_2016v2015 <- ggplot(status_df, aes(x = st_2015, y = st_2016)) + 
  ...
  labs(title = 'Status: 2016 vs 2015')
