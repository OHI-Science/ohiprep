...
Update species names and exclude non-food species. I simplified the species_list.  I cut one of the name columns because it wasn't always clear what this was trying to accomplish.  I also made the "alias" list more complete. This is used
when there is a more general match in the Trujillo data.
```{r}
...
## 3280 of these out of 25598+3280 cases
...
(NOTE: These data have been simplified from last year. I eliminated some of the genus gapfilling.  Given that it 
