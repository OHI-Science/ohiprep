...
library(raster)
raster(file.path(dir_neptune_data, "git-annex/Global/NCEAS-Regions_v2014/data/sp_inland_mol.tif"))
...
m <- m %>%
  ...
  mutate(area_km2 = area_m2/(500*500)) %>%      ###change to match cell size
