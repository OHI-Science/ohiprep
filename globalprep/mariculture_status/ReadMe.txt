...
FAO mariculture harvest data with values from freshwater environment excluded (queried on FishStatJ on May 20, 2015).
 ...
 data files:
 1) mar_trend_years_2015a_lyr
for each country, a code specifying whether to use the most recent 5 years (‘5_yr’), or avoid using the last of the 5 years (‘4_yr’) in calculating the trend

 2) mar_sustainability_score_2015a_lyr
rgn_id = ohi ID
