...
[NOTE: The most recent 2014 country scores are available from [Github](), see https://github.com/OHI-Science/ohi-global/releases]]
...
- **Github repository: ohi-global** The most recent results for the 2012-2014 global analyses, as well as the underlying data and methods (i.e., code), are available from [Github]( https://github.com/OHI-Science/ohi-global/releases). If these data are used, please cite:
