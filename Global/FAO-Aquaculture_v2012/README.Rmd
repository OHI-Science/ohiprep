...
mar_nm_2013 <- read.csv('ohiprep/Global/FAO-Aquaculture_v2012/tmp/cn_nm_change_mar2013.csv')
c1<-mar_nm_2013[,1]
c1
...
# )
# dir_d = '../ohiprep/Global/FAO-Aquaculture_v2012'
# mar_nm_2013 <- read.csv(file.path(dir_d,'tmp/cn_nm_change_mar2013.csv')) 
# c1<-mar_nm_2013[,1]
# # head(mar_nm_2013)
...
that didn't work as I had hoped :(