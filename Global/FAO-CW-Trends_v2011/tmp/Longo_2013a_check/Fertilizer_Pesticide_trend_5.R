...
Fert_Delta12 = ddply(
  ...
  trend = min(lm(tonnes ~ year)$coefficients[[2]]/(2005*lm(tonnes ~ year)$coefficients[[2]]+lm(tonnes ~ year)$coefficients[['(Intercept)']]) * 5,1)) # normalize trend by dividing by fitted value of first year
...
Fert_Delta13 = ddply(
  fert_pest2[fert_pest2$layer=="Fertilizers",], .(rgn_id), summarize,
  trend = min(lm(tonnes ~ year)$coefficients[[2]]/(2006*lm(tonnes ~ year)$coefficients[[2]]+lm(tonnes ~ year)$coefficients[['(Intercept)']]) * 5,1)) # normalize trend by dividing by fitted value of first year
...
Pop_Delta12 = ddply(
  ...
  trend = min(lm(Coast_POP ~ year)$coefficients[[2]]/(2005*lm(Coast_POP ~ year)$coefficients[[2]]+lm(Coast_POP ~ year)$coefficients[['(Intercept)']]) * 5,1)) # normalize trend by dividing by fitted value of first year

Pop_Delta13 = ddply(
    POPdata2[POPdata2$year%in%c(2006:2010),], .(rgn_id), summarize,
    trend = min(lm(Coast_POP ~ year)$coefficients[[2]]/(2006*lm(Coast_POP ~ year)$coefficients[[2]]+lm(Coast_POP ~ year)$coefficients[['(Intercept)']]) * 5,1)) # normalize trend by dividing by fitted value of first year
